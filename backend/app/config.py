...
class Settings(BaseSettings):
    ...
    maps_expand_nearby: bool = True  # fan out each search to a lat/lng grid around the seed centroid
    maps_expansion_max_tiles: int = 6  # cap on additional /maps calls per search (1 seed + N tiles)
    maps_expansion_max_radius_km: float = 50.0  # hard cap on how far tiles may drift from seed centroid
